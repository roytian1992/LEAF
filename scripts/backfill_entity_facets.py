...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Backfill entity-derived facet snapshots from existing LEAF objects and events."
    )
...
def main() -> None:
    ...
    try:
        ...
        for corpus_id in corpus_ids:
            result = service.backfill_entity_facets(corpus_id=corpus_id)
            rows.append({"corpus_id": corpus_id, "result": result})
